...
import org.helloForge.model.Produto;
...
public class ProdutoBean implements Serializable
{
   ...
   @PersistenceContext(unitName = "helloForge-persistence-unit", type = PersistenceContextType.EXTENDED)
